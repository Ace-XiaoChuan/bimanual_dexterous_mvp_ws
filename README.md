...
### Post-MVP E：航空插头插接与柔顺控制

航空插头插接、力/触觉反馈、admittance / impedance 控制、卡阻检测和
失败恢复属于接触型装配研究。Peg-in-Hole 可作为早期简化模型，但最终任务
应收敛到插头/插座键位方向、接近轴、预插接位姿和低速插接。建议先在仿真中
做大间隙、低速、固定初始位姿的简化插接，再过渡到真机接触实验。

验收重点：

```text
1. 插头、插座、键位方向和插接轴在已知坐标系下定义；
2. 机械臂能低速沿插接轴直线运动；
3. 能判断插接成功、超时或失败；
4. 能记录插接深度、最终位姿和错误码；
5. 有急停、速度限制和工作空间限制；
