...
`assembly_tests` 会自动启动 MVP-0 fake 系统，并通过公开 ROS 接口覆盖：
...
后续增强验收项；任务层仍保留对应错误处理路径。详细覆盖范围见
`doc/mvp0/acceptance/interface_snapshot.md` 和
`doc/mvp0/acceptance/known_limitations.md`。
